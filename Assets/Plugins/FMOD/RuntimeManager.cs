...
retry:
            ...
            uint a;
            int b;
            FMODUnity.RuntimeManager.LowlevelSystem.getDSPBufferSize(out a, out b);/* 
            print("1-"+a);
            print("2-"+b); */

            //FMODUnity.RuntimeManager.LowlevelSystem.setDSPBufferSize(512, 2);
        ...
        public static bool HasBankLoaded(string loadedBank)
        {
            ...
            print(loadedBank);
            print(instance);
            print(instance.loadedBanks);
            print(instance.loadedBanks.ContainsKey(loadedBank)); */
